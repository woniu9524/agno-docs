...
**Agno is a framework for building agentic systems**, engineers use agno to:

- **Build Agents with memory, knowledge, tools and reasoning.**
- **Build teams of Agents that can work together.**
- **Chat with Agents using a beautiful Agent Playground.**
...
<Steps>
  ...
  <Step title="Export your OpenAI key">
    ...
    Agno works with every LLM but for these examples let's use OpenAI.
...
Come chat with us on [discord](https://agno.link/discord) or post your questions on the [community forum](https://community.agno.com).
...
We provide dedicated support and development, [book a call](https://agno.link/book-a-call) to get started.
