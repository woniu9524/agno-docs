...
```python cookbook/agent_concepts/tools/python_tools.py
...
- View [Tools](https://github.com/phidatahq/agno/blob/main/libs/agno/agno/tools/python.py)
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/tools/python_tools.py)
