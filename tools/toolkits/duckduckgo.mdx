...
```python cookbook/agent_concepts/tools/duckduckgo.py
...
- View [Tools](https://github.com/phidatahq/agno/blob/main/libs/agno/agno/tools/duckduckgo.py)
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/tools/duckduckgo_tools.py)
