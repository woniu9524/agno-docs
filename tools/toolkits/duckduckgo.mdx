...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/duckduckgo.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/duckduckgo_tools.py)
