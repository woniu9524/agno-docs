...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/mlx_transcribe.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/mlx_transcribe_tools.py)
