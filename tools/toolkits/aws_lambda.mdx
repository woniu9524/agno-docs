...
- View [Tools](https://github.com/phidatahq/agno/blob/main/libs/agno/agno/tools/aws_lambda.py)
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/tools/aws_lambda_tools.py)
