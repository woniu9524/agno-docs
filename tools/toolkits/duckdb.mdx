...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/duckdb.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/duckdb_tools.py)
