...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/pandas.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/pandas_tools.py)
