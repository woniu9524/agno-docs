...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/baidusearch.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/baidusearch_tools.py)
