...
class CustomZoomTool(ZoomTools):
    def __init__(
        self,
...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/zoom.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/zoom_tools.py)
