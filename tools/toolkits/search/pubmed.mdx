...
**PubmedTools** 使 Agent 能够搜索 Pubmed 文章。
...
| `max_results` | `int` | `None`                  | 可选参数，用于指定要返回的最大结果数。                               |

## Toolkit 函数

| 函数            | 描述                                                                                                                                                                                                                                                                                                                        |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `search_pubmed` | 根据指定的查询搜索 PubMed 文章。参数包括用于搜索词的 `query` 和用于指定要返回的最大结果数的 `max_results`（默认为 10）。返回一个包含搜索结果的 JSON 字符串，其中包括出版日期、标题和摘要。 |
