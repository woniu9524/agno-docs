...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/exa.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/exa_tools.py)
