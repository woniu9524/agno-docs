...
从[此处](https://api.slack.com/tutorials/tracks/getting-a-token)获取 Slack 令牌。
...
# 示例 1：向 #general 频道发送消息“Hello from Agno!”
...
| `list_channels`  | 列出 Slack 工作区中所有可用的频道      |
| `get_channel_history` | 从指定的频道检索消息历史记录 |
