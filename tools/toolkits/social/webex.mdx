...
**WebexTools** 使代理能够与 Cisco Webex 交互，允许其发送消息和列出房间。

## 先决条件

以下示例需要 `webexpythonsdk` 库和 Webex 访问令牌，可以通过 [Webex Developer Portal](https://developer.webex.com/docs/bots) 获取。

开始使用 Webex：

1. **创建 Webex Bot：**
   - 前往 [Developer Portal](https://developer.webex.com/)
