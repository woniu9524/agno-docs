...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/shell.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/shell_tools.py)
