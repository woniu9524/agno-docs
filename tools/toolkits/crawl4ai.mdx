...
The following agent will scrape the content from the https://github.com/phidatahq/agno webpage:
...
agent.print_response("Tell me about https://github.com/phidatahq/agno.")
```
...
- View [Tools](https://github.com/phidatahq/agno/blob/main/libs/agno/agno/tools/crawl4ai.py)
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/tools/crawl4ai_tools.py)
