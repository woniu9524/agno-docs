...
The following agent will scrape the content from the https://github.com/AgnoAgi/agno webpage:
...
agent.print_response("Tell me about https://github.com/AgnoAgi/agno.")
```
...
- View [Tools](https://github.com/AgnoAgi/agno/blob/main/libs/agno/agno/tools/crawl4ai.py)
- View [Cookbook](https://github.com/AgnoAgi/agno/blob/main/cookbook/agent_concepts/tools/crawl4ai_tools.py)
