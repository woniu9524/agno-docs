...
以下示例需要 `PyGithub` 库和一个 Github 访问令牌，该令牌可在此处获取：[https://github.com/settings/tokens](https://github.com/settings/tokens)。
...
以下 Agent 将搜索 Google 以获取关于“Mistral AI”的最新新闻：
...
| `base_url`            | `str`  | `None` | Github 企业安装的可选基础 URL。                                                                       |
...
| `get_pull_request_changes` | `bool` | `True` | 启用获取拉取请求文件更改。                                                                          |
