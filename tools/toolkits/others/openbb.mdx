...
**OpenBBTools** 使 Agent 能够提供有关股票和公司的信息。
...
| `include_summary` | `bool` | `False` | 指定是否在文章全文内容中包含文章摘要。                               |
...
| 函数                | 描述                                                                 |
| ------------------- | -------------------------------------------------------------------- |
| `get_stock_price`   | 此函数获取股票代码或股票代码列表的当前股票价格。                     |
| `search_company_symbol` | 此函数搜索公司的股票代码。                                           |
| `get_price_targets` | 此函数获取股票代码或股票代码列表的价格目标。                         |
| `get_company_news`  | 此函数获取股票代码或股票代码列表的最新新闻。                         |
| `get_company_profile` | 此函数获取股票代码或股票代码列表的公司简介。                         |
