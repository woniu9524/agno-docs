...
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `web_crawler` | Crawls a website using crawl4ai's WebCrawler. 参数 include 'url' for the URL to crawl and an optional 'max_length' to limit the length of extracted content. The default value for 'max_length' is 1000. |
