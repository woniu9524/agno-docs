...
**WebsiteTools** 使 Agent 能够解析网站并将其内容添加到知识库中。
...
| 函数                        | 描述                                                                                                                                                                                                          |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `add_website_to_knowledge_base` | 此函数将网站内容添加到知识库。**注意：** 网站必须以 `https://` 开头，并且必须是有效的网站。使用此函数从互联网获取有关产品的信息。 |
| `read_url`                      | 此函数读取 URL 并返回其内容。                                                                                                                                                                  |
