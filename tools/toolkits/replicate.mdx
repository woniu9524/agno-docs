...
```python cookbook/agent_concepts/tools/replicate_tool.py
...
- View [Tools](https://github.com/phidatahq/agno/blob/main/libs/agno/agno/tools/replicate.py)
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/tools/replicate_tools.py)
