Thank you for using Agno to build your hackathon project! Here you'll find quickstart guides, examples, and resources to help you quickly bring your multimodal agent to life.

## Getting Started

<CardGroup cols={3}>
  <Card title="Setup"  icon="user-astronaut" iconType="duotone" href="/get-started/agents">
    Learn how to build Agents with Agno
  </Card>
  <Card title="Code Examples" icon="comment-dots" iconType="duotone" href="/get-started/playground">
    Chat with your Agents using a beautiful Agent UI
  </Card>
  <Card title="Replit App" icon="rocket-launch" iconType="duotone" href="/get-started/monitoring">
