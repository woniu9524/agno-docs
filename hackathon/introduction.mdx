...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="rocket-launch"
    iconType="duotone"
    href="https://agno.link/hack-repl"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="image"
    iconType="duotone"
    href="/hackathon/examples/image-gif-seach"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    title="Audio Generate Podcast"
    icon="music"
    iconType="duotone"
    href="/hackathon/examples/audio-generate-podcast"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="video"
    iconType="duotone"
    href="https://github.com/agno-agi/agno/tree/main/cookbook/examples/apps/podcast_generator"
  >
    Agent that generates a podcast from an audio input
  </Card>
  <Card
    ...
    icon="gamepad"
    iconType="duotone"
    href="https://github.com/agno-agi/agno/tree/main/cookbook/examples/apps/tic_tac_toe"
  >
    Tic Tac Toe game
  </Card>
</CardGroup>
...
- Browse 100s of other [examples](/examples) and [cookbooks](https://agno.link/cookbooks) for inspiration.
