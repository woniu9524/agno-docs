...
We'll help you build multimodal agents for your hackathon project. We've organized everything you need - from initial setup to examples for copy-pasting.
...
<CardGroup cols={3}>
  ...
  >
    Get your environment ready in just 5 minutes
  </Card>
  <Card
  ...
  >
    Fork our pre-configured Replit template
  </Card>
</CardGroup>
