---
title: 组合知识库
description: 学习如何将多个知识库组合成一个。
sidebarTitle: 组合
---

**CombinedKnowledgeBase** 将多个知识库合并为一个，当您的应用程序需要使用多个来源的信息时使用。
...
from agno.reader import PDFReader # 确保导入 PDFReader
...
`CombinedKnowledgeBase` 是 [AgentKnowledge](/reference/knowledge/base) 类的子类，并且可以访问相同的参数。
