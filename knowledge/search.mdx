...
The Model interprets your query, generates relevant keywords and searches its knowledge base iteratively.

<Tip>
Your Agent is only as good as its search. **Better search = Better responses**
</Tip>
