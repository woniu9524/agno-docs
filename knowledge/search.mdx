...
Using an Agent to iteratively search for information at runtime is called **Agentic Search** and this process of **searching, reasoning and responding** is known as **Agentic RAG**.
