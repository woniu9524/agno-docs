...
**JSONKnowledgeBase** 读取 **本地 JSON** 文件，将它们转换为向量嵌入并加载到向量数据库中。
...
| 参数 | 类型 | 默认值 | 描述 |
|---|---|---|---|
| `path` | `Union[str, Path]` | - | `JSON` 文件的路径。<br/>可以指向单个 JSON 文件或 JSON 文件目录。 |
...
- 查看 [同步加载食谱](https://github.com/agno-agi/agno/blob/main/cookbook/agent_concepts/knowledge/json_kb.py)
- 查看 [异步加载食谱](https://github.com/agno-agi/agno/blob/main/cookbook/agent_concepts/knowledge/json_kb_async.py)