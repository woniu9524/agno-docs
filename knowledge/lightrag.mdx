---
title: LightRAG 知识库
description: 了解如何使用 LightRAG，一个基于图的快速检索增强生成系统，用于增强知识查询。
sidebarTitle: LightRAG
---

**LightRAGKnowledgeBase** 与 [LightRAG 服务器](https://github.com/HKUDS/LightRAG) 集成，这是一个简单快速的检索增强生成系统，它使用图结构来增强文档检索和知识查询能力。
...
| `path` | `Union[str, Path]` | - | 文档的路径。可以指向单个文件或文件目录。 |
| `url` | `str` | - | 要读取的网站的 URL。 |
