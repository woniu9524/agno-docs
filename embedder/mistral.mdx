...
`MistralEmbedder` 类用于通过 Mistral API 将文本数据嵌入到向量中。请在此处获取您的密钥：[https://console.mistral.ai/api-keys/](https://console.mistral.ai/api-keys/)。
...
| 参数           | 类型                       | 默认值        | 描述                                             |
| -------------- | -------------------------- | ------------- | ------------------------------------------------ |
| `model`        | `str`                      | `"mistral-embed"` | 用于生成嵌入的模型的名称。                         |
