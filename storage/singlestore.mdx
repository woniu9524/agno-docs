...
Agno supports using Singlestore as a storage backend for Agents using the `S2AgentStorage` class.
...
- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/storage/singlestore_storage.py)
