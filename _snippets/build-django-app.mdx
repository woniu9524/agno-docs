...
[Django 教程](https://docs.djangoproject.com/en/4.2/intro/tutorial01/) 是学习 Django、进行试验和根据你的用例更新 Web 应用的绝佳场所。以下是创建一个简单聊天应用程序的方法：
...
在此处阅读有关 [Django 应用](https://docs.djangoproject.com/en/4.2/intro/tutorial01/#creating-the-polls-app) 的更多信息
...
打开 [localhost:8000/chat/](http://localhost:8000/chat/) 查看 LLM 聊天应用。

![django-app-chat-app](/images/django-app-chat-app.png)

<Note>

如果需要，可以使用 `ag ws restart dev:docker:app -y` 重启 Django 服务器
