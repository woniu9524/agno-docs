...
SingleStore 支持云部署和本地部署。有关设置云部署的分步指南，请参阅 [SingleStore 设置指南](https://docs.singlestore.com/cloud/connect-to-singlestore/connect-with-mysql/connect-with-mysql-client/connect-to-singlestore-helios-using-tls-ssl/)。
