...
- Added **Reasoning Cookbook** to improve documentation and accessibility.

## Improvements:

- Enhanced debug logs for better readability and clarity.
</Update>
...
- Implemented **async support for Qdrant VectorDB**, improving performance and efficiency.
- Introduced the Claude **Think tool**, following the specified implementation [guide.](https://www.anthropic.com/engineering/claude-think-tool)
