...
Now go to the [phoenix cloud](https://app.phoenix.arize.com) and check the traces sent by your agent. You can visualize the execution flow, monitor performance, and debug issues directly from the Arize Phoenix dashboard.
