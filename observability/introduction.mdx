# Observability in Agno

Observability is crucial for understanding, debugging, and improving AI agents. Agno supports observability through [OpenTelemetry](https://opentelemetry.io/), integrating seamlessly with popular tracing and monitoring platforms.
...
<Note>
OpenTelemetry-compatible backends including Arize-Phoenix, Langfuse, Langsmith, Langtrace and Weave are supported in Agno out of the box.
</Note>
