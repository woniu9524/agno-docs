...
Memory is a critical component of intelligent agents, allowing them to recall past interactions, store important information about users, and maintain context throughout conversations. Agno provides a powerful memory system that enables your agents to create, manage, and utilize different types of memories for more personalized and coherent interactions.

## Types of Memory

Agno's memory system supports three primary types of memory:

1. **Chat History:** The conversation history between users and the agent, stored as sessions in chronological order.
2. **User Memories:** Insights and facts about users extracted from conversations, helping agents personalize responses.
3. **Session Summaries:** Condensed representations of conversations, useful when chat histories grow too long.

Learn more about agent memory [here](/agents/memory). Learn more about managing sessions [here](/agents/sessions).

## Memory Architecture

The `Memory` implementation in Agno provides a comprehensive solution for managing all aspects of user memory:
...
The Memory class offers:

- Easy addition, updating, and deletion of memories
- Persistent storage through various database backends
- Automatic creation of user memories from conversations
- Semantic search capabilities across stored memories
