...
Agno agents support text, images, audio and video for agent inputs and responses. For a complete overview, please checkout the [Compatibility matrix](compatibility-matrix).

## Provide multimodal inputs to an agent
...
## Obtain multimodal outputs from an agent
