...
Storage is also useful for evaluating Agent sessions, extracting few-shot examples and building internal monitoring tools. It lets us **look at the data** which helps us build better Agents.
</Tip>
