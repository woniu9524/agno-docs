...
If you're building intelligent agents, you need to give them **the ability to learn about their user and personalize their responses**. Memory comes in 3 shapes:
...
Because the Memory is managing the `messages` list for the Agent, we can give the Agent access to the chat history in the following ways:
