...
TODO: Explicitly set the model on the team leader and team members

TODO: Note on workflows as an alternative

## Developer Resources

- View [Cookbook](https://github.com/phidatahq/agno/blob/main/cookbook/agent_concepts/teams/hackernews_team.py)
