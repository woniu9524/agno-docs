---
title: What is Agno?
description: "**Agno is a full-stack framework for building Agentic Systems with memory, knowledge and reasoning.**"
...
<Frame caption="Here's the Reasoning Finance Agent in action">
  <video
    autoPlay
    muted
    controls
...
- **Highly performant**: Agents instantiate in **~3μs** and use **~5Kib** memory on average.
...
If you're new to Agno, start by building your [first Agent](/introduction/agents), chat with it on the [playground](/introduction/playground) and monitor it on [app.agno.com](https://app.agno.com) using this [guide](/introduction/monitoring).
...
After that, dive deeper into the concepts below or explore the [Examples Gallery](/examples) and build real-world applications with Agno.
