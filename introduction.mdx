...
<CardGroup cols={3}>
  ...
  <Card title="Models" icon="brain" iconType="duotone" href="/models">
  ...
  <Card title="Reasoning" icon="brain-circuit" iconType="duotone" href="/reasoning">
    Improve your Agents by making them "think" and "analyze".
  </Card>
  ...
  <Card
    ...
    href="/vectordb"
  >
    Vector databases to store and search your knowledge base.
  </Card>
  ...
  <Card
    ...
    href="/workflows"
  >
    Build deterministic, stateful, multi-agent workflows.
  </Card>
  <Card
    title="Evals"
    icon="shield"
