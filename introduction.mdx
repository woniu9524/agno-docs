...
description: "**Agno is a lightweight, model-agnostic framework for building Agents.**"
---
...
- **Lightning Fast**: Agent creation is 6000x faster than LangGraph ([performance](https://github.com/agno-agi/agno/tree?tab=readme-ov-file#performance)).
