...
Agno will help you build best-in-class, highly-performant agents without the hours spent on boilerplate and research. Here are some key features:

- **Model Agnostic**: Use any model, any provider, no lock-in.
- **High performance**: Agents instantiate in **~3μs** and use **~5Kib** memory on average.
...
After that, dive deeper into the concepts below or checkout the [Examples Gallery](/examples) and build real-world applications with Agno.
