...
Agno 模板使用 [pyproject.toml](https://packaging.python.org/en/latest/specifications/declaring-project-metadata/#declaring-project-metadata) 文件来管理依赖项，**该文件用于通过 [pip-tools](https://pip-tools.readthedocs.io/en/latest/) 生成 `requirements.txt` 文件。**
