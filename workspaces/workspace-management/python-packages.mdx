...
Agno 模板使用 [pyproject.toml](https://packaging.python.org/en/latest/specifications/declaring-project-metadata/#declaring-project-metadata) 文件来管理依赖项，**该文件用于通过 [uv](https://github.com/astral-sh/uv) 或 [pip-tools](https://pip-tools.readthedocs.io/en/latest/) 生成 `requirements.txt` 文件。**

添加或更新 Python 库是一个包含 2 个步骤的过程：
