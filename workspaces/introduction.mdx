...
Workspaces are standardized codebases for Agentic Systems. They contain:
...
Having built 100s of such systems, we have a standard set of codebases we use and we call them **Workspaces**.
Think of **Workspaces** as an umbrella for your AI project, which helps you manage your Agentic Infrastructure as a monorepo.
