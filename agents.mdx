...
Agno includes a built-in debugger that will show debug logs in the terminal. You can set `debug_mode=True` on any agent or set `AGNO_DEBUG=true` in your environment.
