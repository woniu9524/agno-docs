...
description: 'A team that gets the responses from all team members collaboratively and combines them into a single response'
---

# Collaborate Mode

Collaborate mode allows all team members to respond to the user query at once. This gives the team coordinator to review whether the team has reached a consensus on a particular topic and then synthesize the responses from all team members into a single response.
