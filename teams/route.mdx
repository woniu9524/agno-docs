---
title: 'Route Mode'
description: 'Direct user requests to the most appropriate team member'
---

# Route Mode

Route mode is a team collaboration approach where user queries are directed to the most appropriate team member based on the content of the request. 
The team acts as a smart router, analyzing the query and selecting the best-suited agent to handle it. The member's response is then returned directlyto the user.
...
2. A routing agent analyzes the query to determine which team member has the right expertise
