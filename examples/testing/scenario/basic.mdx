...
> **提示：** 想看一个更高级的场景吗？请查看 [客户支持场景示例](https://github.com/langwatch/create-agent-app/tree/main/agno_example)，其中包含更复杂的代理，包括工具调用和高级场景功能。
...
<Steps>
  ...
  <Step title="设置您的 API 密钥">
    ...
    export LANGWATCH_API_KEY=xxx # 可选，模拟监控需要
    ```
  </Step>
