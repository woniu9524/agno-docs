...
<Steps>
  ...
  <Step title="Install Dependencies">
    ```bash
    pip install -r cookbook/examples/streamlit_applications/geobuddy/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the App">
    ```bash
    streamlit run cookbook/examples/streamlit_applications/geobuddy/app.py
    ```
  </Step>
