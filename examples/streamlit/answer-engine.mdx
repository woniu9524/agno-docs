...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    pip install -r cookbook/examples/streamlit_applications/answer_engine/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the app">
    ```bash
    streamlit run cookbook/examples/streamlit_applications/answer_engine/app.py
    ```
