...
<Steps>
  ...
  <Step title="Install dependencies">
    ```bash
    pip install -r cookbook/examples/streamlit_applications/sql_agent/requirements.txt
    ```
  </Step>
  ...
  <Step title="Load F1 data">
    ```bash
    python cookbook/examples/streamlit_applications/sql_agent/load_f1_data.py
    ```
  </Step>
  ...
  <Step title="Load knowledge base">
    ...
    ```bash
    python cookbook/examples/streamlit_applications/sql_agent/load_knowledge.py
    ```
  ...
  <Step title="Launch the app">
    ```bash
    streamlit run cookbook/examples/streamlit_applications/sql_agent/app.py
    ```
