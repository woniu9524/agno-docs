...
### Code
The complete code is available in the [Agno repository](https://github.com/agno-agi/agno/tree/main/cookbook/examples/streamlit_applications/chess_team).
...
<Steps>
  ...
  <Step title="Install Dependencies">
    ```bash
    pip install -r cookbook/examples/streamlit_applications/chess_team/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the App">
    ```bash
    streamlit run cookbook/examples/streamlit_applications/chess_team/app.py
    ```
  </Step>
