...
### Code
The complete code is available in the [Agno repository](https://github.com/agno-agi/agno/tree/main/cookbook/examples/streamlit_applications/tic_tac_toe).
...
<Steps>
  ...
  <Step title="Install Dependencies">
    ```bash
    pip install -r cookbook/examples/streamlit_applications/tic_tac_toe/requirements.txt
    ```
  </Step>
  ...
  <Step title="Launch the App">
    ```bash
    streamlit run cookbook/examples/streamlit_applications/tic_tac_toe/app.py
    ```
  </Step>
