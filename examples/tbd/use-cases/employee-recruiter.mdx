...
---
**EmployeeRecruiter** screens resumes, schedules interviews, and sends email invitations to selected candidates.

Create a file `employee_recruiter.py` with the following code:
