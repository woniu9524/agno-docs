---
title: "Portkey"
description: "Enhance your Agno agents with Portkey for reliability, efficiency, and advanced features"
---

# Portkey Integration with Agno
...
[Portkey](https://portkey.ai) is a 2-line upgrade to make your Agno agents reliable, cost-efficient, and fast.

Portkey adds 4 core production capabilities to any Agno agent:
...
```bash
pip install agno portkey-ai
```

2. **Configure Agno with Portkey:**
...
And, that's it! With just this, you can start logging all of your Agno requests and make them reliable.
...
Portkey offers a range of advanced features to enhance your Agno agents. Here's an overview:
...
For a hands-on example of integrating Portkey with Agno, check out our notebook:
