...
本示例展示了如何创建一个 AI 烹饪助手，该助手结合了来自精选食谱数据库的知识、网络搜索能力和持久化存储。该代理使用真实的泰国食谱的 PDF 知识库，并在需要时通过网络搜索来补充这些信息。

您可以尝试的示例提示：
- "authentic Pad Thai" 怎么做？
- 红咖喱和绿咖喱有什么区别？
- 能解释一下高良姜（galangal）是什么，以及可能的替代品吗？
- 讲讲冬阴功汤的历史
- 泰式厨房必备的食材有哪些？
- 泰式罗勒鸡（Pad Kra Pao）怎么做？
