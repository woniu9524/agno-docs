...
本示例展示了如何创建一个能够处理音频输入并生成音频响应的 AI 代理。您可以将此代理用于各种基于语音的交互，从分析语音内容到生成自然的语音响应。
...
agent = Agent(
    ...
    description=dedent("""\
        您是音频处理和语音交互方面的专家，能够理解和分析语音内容，并提供自然、引人入胜的语音响应。
...
"""
尝试以下语音交互场景：
1. “你能总结一下这段录音中讨论的主要内容吗？”
2. “你在这位说话者的声音中检测到了什么情感或语调？”
3. “请详细分析说话模式和清晰度”
4. “你能识别出任何背景噪音或音频质量问题吗？”
5. “这段录音的整体背景和目的是什么？”

注意：您可以通过将音频文件转换为 base64 格式来使用自己的音频文件。
使用自己的音频文件的示例：
