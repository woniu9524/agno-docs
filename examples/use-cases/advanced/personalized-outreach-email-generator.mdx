---
title: Personalized Outreach Email Generator
---
**PersonalizedOutreachEmailGenerator** creates a personalized marketing email for a given company.

Create a file `personalized_marketing.py` with the following code:

```python personalized_marketing.py
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install openai firecrawl-py resend email_validator
    ```
  </Step>
