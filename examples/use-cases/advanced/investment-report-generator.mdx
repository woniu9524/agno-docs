...
---
**InvestmentReportGenerator** produces detailed investment research reports, ranks companies by investment potential, and creates an investment proposal based on user-provided company symbols.

Create a file `investment_report_generator.py` with the following code:
