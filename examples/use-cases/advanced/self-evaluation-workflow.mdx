---
title: Self Evaluation Workflow
---
**SelfEvaluationWorkflow** generates and refines content through iterative feedback between a content creator agent and a content reviewer agent

Create a file `self_evaluation_workflow.py` with the following code:

```python self_evaluation_workflow.py
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install openai pydantic agno
    ```
  </Step>
