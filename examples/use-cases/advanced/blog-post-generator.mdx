...
---
**BlogPostGenerator** generates professional blog posts on any given topic using web search insights and AI-driven writing.

Create a file `blog_post_generator.py` with the following code:
