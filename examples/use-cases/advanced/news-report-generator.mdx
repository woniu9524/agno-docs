...
---
**NewsReportGenerator** generates a comprehensive news report on a given topic by searching articles, scraping their content, and synthesizing them into a New York Times-worthy summary.

Create a file `news_report_generator.py` with the following code:
