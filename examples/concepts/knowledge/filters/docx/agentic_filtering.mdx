---
title: 使用 Docx 进行智能过滤
description: 了解如何使用具有用户特定元数据的 Docx 文档进行智能知识过滤。
---
...
# 步骤 2：使用 Agent 和查询中的过滤器（由 Agent 自动拾取）来查询知识库
# -----------------------------------------------------------------------------------
...
agent.print_response(
    "告诉我 Jordan Mitchell 的经验和技能，用户 ID 为 jordan_mitchell，文档类型为 cv",
    markdown=True,
)
```
