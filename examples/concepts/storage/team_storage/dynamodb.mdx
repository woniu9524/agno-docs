...
Agno は、`DynamoDbStorage` クラスを使用して、チームのストレージバックエンドとして DynamoDB をサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/dynamodb_storage/dynamodb_storage_for_team.py)を表示