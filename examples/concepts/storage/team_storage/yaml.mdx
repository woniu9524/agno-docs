...
Agno は、`YamlStorage` クラスを使用して、ローカル YAML ファイルをチームのストレージバックエンドとしてサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/yaml_storage/yaml_storage_for_team.py)を表示