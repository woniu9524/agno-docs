...
Agno は、`YamlStorage` クラスを使用して、ローカル YAML ファイルをワークフローのストレージバックエンドとしてサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/yaml_storage/yaml_storage_for_workflow.py)を表示