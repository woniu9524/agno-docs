...
Agno は、`SqliteStorage` クラスを使用して、ワークフローのストレージバックエンドとして SQLite をサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/sqllite_storage/sqlite_storage_for_workflow.py) を表示