---
title: DynamoDB ワークフロー ストレージ
sidebarTitle: DynamoDB
---

Agno は、`DynamoDbStorage` クラスを使用して、ワークフローのストレージバックエンドとして DynamoDB をサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/dynamodb_storage/dynamodb_storage_for_workflow.py)を表示