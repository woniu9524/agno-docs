...
Agno は、`MongoDbStorage` クラスを使用して、ワークフローのストレージバックエンドとして MongoDB をサポートしています。

## 使用方法

### MongoDB の実行

[docker desktop](https://docs.docker.com/desktop/install/mac-install/) をインストールし、以下のコマンドでポート **27017** で **MongoDB** を実行します。
...
- [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/storage/mongodb_storage/mongodb_storage_for_workflow.py) を表示