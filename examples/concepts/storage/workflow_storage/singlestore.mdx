...
Agno は、`SingleStoreStorage` クラスを使用して、Workflows のストレージバックエンドとして Singlestore を利用することをサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/singlestore_storage/singlestore_storage_for_workflow.py)を表示