---
title: JSON ワークフロー ストレージ
sidebarTitle: JSON
---

Agno は、`JsonStorage` クラスを使用して、ワークフローのストレージバックエンドとしてローカル JSON ファイルを使用することをサポートしています。
...
- [クックブック](https://github.com/agno-agi/agno/blob/main/cookbook/storage/json_storage/json_storage_for_workflow.py)を表示