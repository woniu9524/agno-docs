...
<CardGroup cols={3}>
  ...
  <Card title="Structured Outputs"  icon="code" iconType="duotone" href="/examples/concepts/structured-outputs">
    Generate structured outputs using Agents
  </Card>
  ...
  <Card title="Workflows" icon="diagram-project" iconType="duotone" href="/examples/concepts/workflows">
    Build deterministic, multi-agent workflows
  </Card>
