...
- Query generation follows a set of rules
...
The complete code is available in the [agno repository](https://github.com/agno-api/agno).
...
<Steps>
  ...
  <Step title="Load knowledge base">
    ...
    - Add sample queries to `cookbook/use_cases/apps/sql/knowledge_base/sample_queries.sql`
  </Step>
...
Need help? Join our [Discord community](https://agno.link/discord) for support!