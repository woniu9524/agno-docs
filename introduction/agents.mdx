...
While models have a large corpus of training data, we almost always need to give Agents a specific set of knowledge related to our domain. This isn't just for RAG, but more importantly, its used to dynamically provide few-shot examples to the model.
