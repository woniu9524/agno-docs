...
**Model**, **tools** and **instructions** make up the core of an Agent:
...
- **instructions:** guide the behavior of an Agent. Better the model, better it is at following instructions.
...
While models have a large amount of training data, we almost always need to give Agents a specific set of domain-specific information to help it achieve its task. This isn't just for RAG, but more importantly, its used to dynamically provide few-shot examples to the model.
