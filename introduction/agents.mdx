...
sidebarTitle: What are Agents?
---

Traditional software functions follow a pre-programmed sequence of steps. Agents dynamically determine their course of action using a machine learning **model**, execute tasks using **tools**, and are programmed using **instructions**.

- **Model:** controls the flow of execution. It decides whether to reason, act or respond.
- **Tools:** enable the Agent to interact with external systems.
- **Instructions:** teach the Agent how to act and guide its behavior.

Agents also have **memory**, **knowledge**, **storage** and the ability to **reason**:

- **Reasoning:** enables Agents to "think" before responding and "analyze" the results of their actions (i.e. tool calls), this improves reliability and the quality of the response.
- **Knowledge:** is domain-specific information that the Agent can **search at runtime** to make better decisions and provide accurate responses. Knowledge is stored in a vector database and this **search at runtime** pattern is known as Agentic RAG/Agentic Search.
