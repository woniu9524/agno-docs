...
description: Debug and monitor your Agents, Teams and Workflows in real-time.
---
...
Run your agent and view track its session on the [sessions page](https://app.agno.com/sessions).
