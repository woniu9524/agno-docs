...
description: "Teams of Agents that work together towards a common goal."
...
Workflows are deterministic, stateful, multi-agent programs built for production applications. We write the workflow logic in pure python, which gives us extreme control over the execution flow.
